...
?>
		...
		<nav class="nav-image" role="navigation">
			<div class="previous-image"><?php previous_image_link( '%link', __( '&larr; Previous', 'renkon' )); ?></div>
			<div class="next-image"><?php next_image_link(  '%link', __( 'Next &rarr;', 'renkon' ) ); ?></div>
		</nav>
